...
def extract_teachers():
    ...
    while True:
        try:
            professeur = driver.find_element(By.ID, f"GInterface.Instances[1].Instances[1]_bloc{block}")
            filiereplus = driver.find_element(By.ID, f"GInterface.Instances[1].Instances[1]_bloc{block+1}")
